...
const Banner = () => {
    return (
        <div className="relative w-full border-amber-100 border-b-8  flex items-center justify-center px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]  sm:py-12 md:py-16  overflow-hidden">
